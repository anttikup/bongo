...
(async () => {
    ...
    const statscat = await learningStatsLib.getLearningStatsForCategory({ userId: 49523197 }, 'notename');
    ...
    const weightsTable = await learningStatsLib.getWeightsForCategory({ userId: 49523197 }, 'notename');
